 ...
 * Description: Shadow-mode packet manifest definition template and section contract helpers.
 */
...
export const PACKET_MANIFEST_DEFINITION_TEMPLATE = [
  {
    ...
    required_for_shadow_definition: true,
  },
  {
    section_key: 'schema',
    status: 'supported',
  ...
  },
  {
    ...
    required_for_shadow_definition: false,
  },
  {
    section_key: 'notes',
    status: 'supported',
...
export function listRequiredPacketManifestTemplateSectionKeys(): PacketManifestSectionKey[] {
  return PACKET_MANIFEST_DEFINITION_TEMPLATE.filter(
    (section) => section.required_for_shadow_definition

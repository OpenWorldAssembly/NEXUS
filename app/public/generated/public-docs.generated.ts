...
export const PUBLIC_READABLE_DOCUMENTS = {
  ...
  "implementation-guide": {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Role",
        body: [
          "A reusable role definition packet type. Exact-scope role assertions are currently represented through Claim(subtype: \"relation_assertion\") with subtype: \"role_association\" preserved for compatibility.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "- Cause, Action, Relation, and Location as first-class packet types",
  ...
  "roadmap": {
    ...
    sections: [
      ...
      {
        id: "roadmap-open-questions-and-future-decisions",
        level: 2,
      ...
      {
        id: "roadmap-explicitly-future",
        level: 3,
        title: "Explicitly future",
        body: [

...
export const PUBLIC_READABLE_DOCUMENTS = {
  ...
  "implementation-guide": {
    ...
    sections: [
      ...
      {
        id: "implementation-guide-dispatch-owned-write-pipeline",
        level: 2,
        title: "Dispatch-Owned Write Pipeline",
        body: [
      ...
      {
        id: "implementation-guide-trusted-process-chains-and-issue-taxonomy",
        level: 2,
        title: "Trusted Process Chains and Issue Taxonomy",
        body: [
      ...
      {
        id: "implementation-guide-runtime-cleanup-and-bounded-contexts",
        level: 2,
        title: "Runtime Cleanup And Bounded Contexts",
        body: [
      ...
      {
        id: "implementation-guide-trusted-verification-coordinator-pass",
        level: 2,
        title: "Trusted Verification Coordinator Pass",
        body: [
      ...
      {
        id: "implementation-guide-trusted-compatibility-coordinator-pass",
        level: 2,
        title: "Trusted Compatibility Coordinator Pass",
        body: [
      ...
      {
        id: "implementation-guide-trusted-exchange-coordinator-pass-a",
        level: 2,
        title: "Trusted Exchange Coordinator Pass A",
        body: [
      ...
      {
        id: "implementation-guide-trusted-runtime-coordinator-audit-and-caller-migration-pass",
        level: 2,
        title: "Trusted Runtime Coordinator Audit And Caller Migration Pass",
        body: [
      ...
      {
        id: "implementation-guide-definition-packetization-and-preference-dispatch-promotion",
        level: 2,
        title: "Definition Packetization and Preference Dispatch Promotion",
        body: [
      ...
      {
        id: "implementation-guide-runtime-responsibility-audit",
        level: 2,
        title: "Runtime Responsibility Audit",
        body: [
        ],
      },
      {
        id: "implementation-guide-executive-summary",
        level: 3,
      ...
      {
        id: "implementation-guide-guardrail-housekeeping-baseline",
        level: 3,
        title: "Guardrail housekeeping baseline",
        body: [
      ...
      {
        id: "implementation-guide-ownership-categories",
        level: 3,
        title: "Ownership categories",
        body: [
          "Use these categories when classifying runtime modules and future migrations.",
          "| Category | Meaning | Ideal location | | --- | --- | --- | | trusted_coordinator_front_door | Public coordinator surface and manifest-visible method owner | runtime/trusted_coordinators/<coordinator>/ | | trusted_coordinator_internal | Private coordinator registry, function, type, and internal helper | runtime/trusted_coordinators/<coordinator>/ | | definition_driven_candidate | Hardcoded behavior that should become Definition, defaults, dependency, builder, action, or projection metadata | Usually Definition/Planning/Projection plus packet definitions | | projection_candidate | Read-model logic that should move behind Trusted Projection while preserving API payloads | runtime/trusted_coordinators/trusted_projection_coordinator/ or projection adapter | | storage_adapter | Concrete persistence adapter, schema, bundle storage primitive, or query adapter | runtime/storage/ or Archive-facing storage adapter | | runtime_adapter | API-facing glue that composes coordinators and storage without owning packet semantics | runtime/nexus/server/ bounded context | | owa_product_adapter | OWA-specific profile behavior, civic defaults, locality conventions, or compatibility policy | future runtime/nexus/server/adapters/owa/ or clearly named product module | | compatibility_bridge | Old import path, legacy read fallback, compatibility projection, or temporary wrapper | nearest bounded context with bridge docs | | legacy_signed_corridor | Former Dispatch prepare/finalize/ticket/proof code that must be retired rather than wrapped | replacement through Dispatch, Certification, Verification, and Archive | | test_or_audit | Tests, readiness ledgers, modernization reports, and static audits | near tested subsystem or runtime/nexus/server/readiness/ |",
        ],
      },
      {
        id: "implementation-guide-current-runtime-map",
        level: 3,
        title: "Current runtime map",
        body: [
          "| Area | Current responsibility | Ideal classification | Ideal direction | Risk | | --- | --- | --- | --- | --- | | runtime/trusted_coordinators/ | Trusted orchestration surfaces and internal coordinator functions | trusted_coordinator_front_door / trusted_coordinator_internal | Continue tightening scaffold, process chains, issue taxonomy, and caller migration | Medium | | runtime/storage/ | SQLite packet store, schemas, query services, low-level persistence | storage_adapter | Keep concrete storage here; require Archive for coordinator/server reads where practical | Low | | runtime/nexus/server/packet-explorer/ | Explorer import/export/search/data payload services | runtime_adapter, projection_candidate, compatibility_bridge | Keep API payloads stable while moving read models to Projection and packet movement to Exchange/Archive | Medium | | runtime/nexus/server/discussion/ | Discussion forums, posts, replies, and vote-adjacent projections | owa_product_adapter, projection_candidate, definition_driven_candidate | Treat as transitional; move generic message/thread projection into Projection definitions over time | High | | runtime/nexus/server/reaction/ | Reaction/vote projection and reaction packet service logic | owa_product_adapter, projection_candidate, definition_driven_candidate | Move target/reaction summaries and action availability toward Projection/Definition descriptors | High | | runtime/nexus/server/locality/ | Locality directory, graph planning, location search | owa_product_adapter, definition_driven_candidate, runtime_adapter | Keep OWA locality conventions explicit; move reusable graph/build/dependency rules to Planning/Definition where possible | High | | runtime/nexus/server/scope/ | Scope graph, ancestry compatibility, parent resolution, display preferences | owa_product_adapter, projection_candidate, compatibility_bridge | Separate generic graph projection from OWA policy/profile adapters and legacy compatibility reads | High | | runtime/nexus/server/identity/ | Sessions, passkeys, actor custody, auth storage, identity search | runtime_adapter, storage_adapter, compatibility_bridge | Identity custody remains runtime-owned; packet-specific read/display pieces can move toward Projection | Medium | | runtime/nexus/server/readiness/ | Modernization and pre-reseed readiness reports | test_or_audit | Keep as audit/report layer; update as seams migrate | Low | | remaining mutation- / packet-runtime-* ledgers | Static mutation intent descriptors, ticket compatibility helpers, handoff/readiness ledgers | compatibility_bridge, test_or_audit, legacy_signed_corridor | Keep only what describes transitional state; route executor files are removed | Medium | | top-level nexus-query-data.ts | Broad Nexus read model aggregation | projection_candidate, owa_product_adapter | Decompose by projection responsibility; move generic packet/card/list/read models behind Projection | High | | top-level verification-service.ts | Verification wrapper, validator identity, report writing | compatibility_bridge, runtime_adapter | Keep wrapper short; move report certification/storage decisions later through Certification/Archive | Medium |",
        ],
      },
      {
        id: "implementation-guide-coordinator-readiness-and-gaps",
        level: 3,
        title: "Coordinator readiness and gaps",
        body: [
      ...
      },
      {
        ...
        body: [
          ...
          "| Process | Current files | Ideal owner | Ideal location | Risk | | --- | --- | --- | --- | --- | | mutation prepare/finalize orchestration | trusted_dispatch_coordinator/ plus thin mutation API routes | Dispatch plus Regulation/Planning/Certification/Verification/Archive handoffs | relation.follow.add, relation.association.add, and reaction.vote.set complete the Dispatch-owned route chain; other intents remain capability gaps, not fallback paths | High | | proof/ticket storage | prepared-write-ticket-service.ts, prepared-write-ticket-store.ts | Certification owns signature handoff; Verification owns signed packet validation; Archive owns storage | keep ticket helpers only as transitional compatibility until Certification ticket durability fully replaces them | Medium | | intent schema and enrollment | prepare-mutation-intent-schema.ts, mutation-intent-registry.ts, packet-client-intent-enrollment.ts | Dispatch intake plus Definition-driven client/action metadata | Dispatch/Definition with API schema bridge | Medium | | domain-specific finalize handlers | removed legacy handler-domain executor files | Planning/Building/Inspection/Archive or OWA adapter when product-specific | migrate remaining product intents directly into coordinator chains or adapter bridges, not old handler maps | High | | genericization/handoff audits | packet-runtime-dispatch-handoff.ts, workflow alignment audits | readiness/test audit | readiness/ after terminology cleanup | Low | | Preference write workflow | preference-runtime-connectors.ts, preference runtime connector files | Definition/Planning/Archive plus compatibility cache adapter | migrate claimed Preference.element writes through the trusted chain and retire compatibility cache writes when safe | Medium |",
        ],
      },
      {
        id: "implementation-guide-packet-type-specific-service-inventory",
        level: 3,
        title: "Packet-type-specific service inventory",
        body: [
      ...
      {
        id: "implementation-guide-ideal-destination-map",
        level: 3,
        title: "Ideal destination map",
        body: [
          "| Current pressure area | Ideal destination | First migration step | | --- | --- | --- | | nexus-query-data.ts | Projection coordinator plus OWA read adapter | carve out one route payload behind Projection with exact response parity | | discussion service | Projection definitions plus OWA discussion adapter | isolate projection-only helpers from mutation/session behavior | | reaction service | Projection/action descriptors plus OWA reaction adapter | separate target reaction read model from write path | | locality directory | OWA locality adapter plus Planning/Definition descriptors | identify generic graph/dependency planning pieces | | scope graph | Projection graph base plus OWA scope adapter | split legacy compatibility reads from canonical graph assembly | | Packet Explorer data | Projection/Archive/Compatibility bridge | continue moving Export/Import edge cases behind coordinator seams after the generic inspector and search-card projection migrations | | legacy mutation corridor remnants | Dispatch-owned coordinator chain | keep deleted executor guardrails in audit; classify remaining ticket/handoff ledgers before removal | | verification service | Verification wrapper plus report Certification/Archive handoff | keep assessment wrapper, isolate report-writing surface |",
        ],
      },
      {
        id: "implementation-guide-running-cleanup-tab",
        level: 3,
        title: "Running cleanup tab",
        body: [
          "Use this as the short check-off ledger so the same issues do not have to be rediscovered by later audits.",
          "| Item | Status | Notes | | --- | --- | --- | | Trusted coordinator scaffold/test scripts | Done | audit:trusted-coordinators, test:trusted-coordinators, and check:trusted-coordinators are package-level entrypoints. | | Empty Write Coordinator remnant | Done | Removed; writes remain Dispatch-owned. | | Exchange commit accepted-entry narrowing | Done | Commit bundles are narrowed to accepted plan entries and compare Archive import receipts against the Exchange plan. | | Dispatch finalize raw signed-material handoff | Done | Finalize routes no longer parse signed packets before Dispatch; Verification receives raw signed packet material. | | Certification/Verification/Archive key continuity | Done | Certification records certified packet revision keys; Dispatch compares Certification against Verification and Archive; Archive blocks mismatched extracted envelopes. | | Mutation intent label authority | Done | Dispatch derives finalized kind from the certified plan and rejects mismatched caller labels. | | Resolution foldering | Open | Still the expected legacy-flat warning in the trusted coordinator scaffold audit. | | Direct storage/signature/interpreter runtime crossings | Open | Packet Explorer generic inspector no longer uses the legacy packet interpreter. Direct storage touches are now explicitly classified; remaining coordinator-migration targets are discussion writes, reaction writes, Preference.element helper writes, and Packet Explorer import preferred-head repair. | | Packet Explorer generic projection adoption | Done | The generic inspector payload now gets revision state, edges, raw/adapted reads, and read-model projection through Trusted Archive/Projection while preserving API response shape. | | Packet Explorer search card projection | Done | Search ranking/grouping remains service-owned, but selected search rows now pass through Trusted Projection card-list output before mapping back to the existing response shape. | | Generic query card projection | Partial | Dashboard, votes, and library packet-card lists now pass already-selected cards through Trusted Projection; discussion/reaction/scope/locality read models remain adapter migration lanes. | | Projection adoption | Open | Packet Explorer Export/Import edges, deeper nexus-query-data, discussion/reaction/scope read models remain the biggest migration lane. | | Legacy mutation service registry dependency | Done | NexusMutationService is no longer constructed or exposed by the live Nexus packet service registry. | | Reaction finalize derived-state bridge | Done | reaction.vote.set derived-state response decoration moved out of Trusted Dispatch and into the reaction runtime adapter used by the finalize route. | | Legacy signed-corridor executor removal | Done | Removed the old NexusMutationService, signed-packet finalizer, Dispatch prepare/finalize handlers, old handler domain maps, manifest Dispatch metadata bridges, and preference Dispatch workflow. Runtime/UI naming now uses Dispatch-owned corridor language. | | OWA adapter/profile split | Open | Discussion, reaction, locality, and scope still mix generic runtime with OWA product behavior. |",
        ],
      },
      {
        id: "implementation-guide-recommended-migration-order",
        level: 3,
        title: "Recommended migration order",
        body: [
          "1. Keep route-facing write lifecycle under Dispatch. Removed legacy executor files must stay deleted; remaining handoff/readiness ledgers should stay Dispatch-named and descriptor-only. 2. Move read-model work toward Projection Coordinator where payload parity is straightforward: Packet Explorer's generic inspector and search-card paths have started this migration, and generic dashboard/votes/library cards are partially projected; continue with deeper route query data, then discussion/reaction/scope read models. 3. Move the direct storage migration-target bucket behind Archive, Exchange, Verification, Projection, and Compatibility. The classification guard is in place; next cleanup should reduce the needs_trusted_coordinator bucket rather than rediscovering it. 4. Extend the proven Dispatch write pipeline beyond the first migrated intents: full packet envelope materialization, Certification signed-bundle checks, Verification handoff, Archive storage, and result projection for each live intent. Reaction vote writes now use the chain, with derived summary/index refresh isolated in the finalize route's reaction adapter until Projection owns the read model. 5. Separate OWA-specific adapters from generic runtime. Product profile behavior should be named, not hidden inside generic services. 6. Retire compatibility bridges only after import scans and route tests prove callers have migrated.",
        ],
      },
      {
        id: "implementation-guide-acceptance-standard-for-future-cleanup",
        level: 3,
        title: "Acceptance standard for future cleanup",
        body: [
      ...
      },
      {
        ...
        body: [
          ...
          "| File | Lines | Component/provider candidates | Exported types | Zone | | --- | ---: | --- | --- | --- | | app/components/nexus/identity-shell-context.tsx | 2056 | IdentityShellContext, IdentityShellProvider | — | support | | app/components/nexus/identity-shell-dispatch-adapter.ts | 367 | — | — | support | | app/components/nexus/nexus-auth-gate-types.ts | 12 | — | — | support | | app/components/nexus/nexus-feature-status-context.tsx | 234 | NexusFeatureStatusContext, NexusFeatureStatusOverlay, NexusFeatureStatusProvider | — | support | | app/components/nexus/nexus-feature-status-registry.ts | 203 | — | NexusFeatureStatusKind, NexusFeatureStatusEntry, NexusFeatureStatusId | support | | app/components/nexus/nexus-route-utils.ts | 77 | — | — | support | | app/components/nexus/nexus-shell-chrome-context.tsx | 56 | NexusShellChromeContext, NexusShellChromeProvider | — | support | | app/components/nexus/nexus-shell-context.tsx | 859 | NexusShellContext, NexusShellProvider | — | support | | app/components/nexus/nexus-shell-preferences.ts | 67 | — | NexusShellPreferenceMode, PersistNexusElementPreferenceInput, PersistNexusElementPreferenceResult | support | | app/components/nexus/packet-actions/nexus-packet-action-registry.ts | 57 | — | NexusPacketActionInput, NexusPacketActionHandlers, NexusPacketActionRegistryInput | support |",
        ],
      },
      {
      ...
      {
        id: "implementation-guide-2026-04-23-and-2026-04-24-compatibility-and-dispatch-corrid",
        level: 3,
        title: "2026-04-23 and 2026-04-24 compatibility and Dispatch corridor",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-definition-packetization-and-preference-dispatch-pr",
        level: 3,
        title: "2026-05 definition packetization and Preference Dispatch promotion",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-trusted-runtime-coordinator-audit-and-caller-migrat",
        level: 3,
        title: "2026-05 Trusted runtime coordinator audit and caller migration",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-trusted-process-chains-and-issue-taxonomy",
        level: 3,
        title: "2026-05 Trusted process chains and issue taxonomy",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-runtime-cleanup-bounded-context-foundation",
        level: 3,
        title: "2026-05 Runtime cleanup bounded-context foundation",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-runtime-responsibility-and-ideal-ownership-audit",
        level: 3,
        title: "2026-05 Runtime responsibility and ideal ownership audit",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-dispatch-owned-write-pipeline-correction",
        level: 3,
        title: "2026-05 Dispatch-owned write pipeline correction",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-trusted-runtime-audit-guardrail-housekeeping",
        level: 3,
        title: "2026-05 Trusted runtime audit guardrail housekeeping",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-trusted-exchange-import-commit-hardening",
        level: 3,
        title: "2026-05 Trusted Exchange import commit hardening",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-dispatch-finalize-certification-verification-harden",
        level: 3,
        title: "2026-05 Dispatch finalize certification/verification hardening",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-dispatch-reaction-vote-write-migration",
        level: 3,
        title: "2026-05 Dispatch reaction vote write migration",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-legacy-mutation-service-containment-and-reaction-fi",
        level: 3,
        title: "2026-05 Legacy mutation service containment and reaction finalize adapter",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-packet-explorer-projection-migration-pass",
        level: 3,
        title: "2026-05 Packet Explorer projection migration pass",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-projection-card-list-bridge-migration",
        level: 3,
        title: "2026-05 Projection card-list bridge migration",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-legacy-mutation-executor-deletion",
        level: 3,
        title: "2026-05 Legacy mutation executor deletion",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-30-packet-backed-definition-profile-preference-carr",
        level: 4,
        title: "2026-05-30 - Packet-backed definition profile preference carrier bridge",
        body: [
      ...
      {
        id: "implementation-guide-2026-05-30-archive-backed-definition-profile-preference-dis",
        level: 4,
        title: "2026-05-30 - Archive-backed definition profile preference discovery bridge",
        body: [

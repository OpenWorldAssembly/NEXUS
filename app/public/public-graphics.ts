    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1600 980">
      <defs>
        <linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="55%" stop-color="#02070c" stop-opacity="0.82" />
          <stop offset="100%" stop-color="#000000" />
        </linearGradient>
        <radialGradient id="glowA" cx="24%" cy="22%" r="26%">
          <stop offset="0%" stop-color="${palette.glow}" stop-opacity="0.22" />
          <stop offset="100%" stop-color="${palette.glow}" stop-opacity="0" />
        </radialGradient>
        <radialGradient id="glowB" cx="78%" cy="30%" r="20%">
          <stop offset="0%" stop-color="${palette.accentSoft}" stop-opacity="0.14" />
      ...
      <g opacity="0.16" fill="none" stroke="${palette.accent}" stroke-width="2">
      ...
      <g opacity="0.07" fill="none" stroke="${palette.accentSoft}" stroke-width="1.5">
      ...
      <g opacity="0.055" fill="none" stroke="${palette.ridge}" stroke-width="3">

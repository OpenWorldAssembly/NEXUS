...
- [Open Questions And Deferred Decisions](roadmap/open-questions-and-future-decisions.md)
...
- Should `Claim` remain a distinct type long term, or eventually converge with a broader attestation umbrella?

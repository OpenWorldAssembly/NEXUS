...
import { createTextExcerpt } from '@/domain/packets/builders';
import type {
  AttestationService,
  AttestationSummary,
...
import { resolveDiscussionScopePacketId } from '@/lib/nexus/discussion-packets';
import type {
...
function toDiscussionForumId(forumKind: string): string {

...
export default function Header() {
  ...
  const headerShellClassName = isStackedHeader
    ? 'mx-auto flex w-full max-w-6xl flex-col items-center gap-3 px-5 py-4'
    : 'mx-auto flex w-full max-w-6xl flex-row items-center justify-between gap-4 px-5 py-4';
  const brandClassName = isStackedHeader
    ? 'self-center rounded-full border border-public-line/0 bg-public-panel/50 px-4 py-2'
  ...
  const navClassName = isStackedHeader
    ? 'flex-row flex-wrap items-center justify-center gap-x-1 gap-y-1'

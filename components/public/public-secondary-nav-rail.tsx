...
} from '@/components/public/public-secondary-nav.types';
import { SECTION_RAIL_WIDTH } from '@/components/layout/about/use-about-page-controller';
...
type PublicSecondaryNavRailProps = {
  ...
  subtitle?: string;
  title: string;
  getItemAnimatedState?: (itemId: string) => PublicSecondaryNavAnimatedState;
...
export default function PublicSecondaryNavRail({
  ...
  return (
    <View pointerEvents="box-none" style={[styles.railViewportOverlay, { right: railRightOffset }]}>

...
const CLIENT_INTENT_BY_MUTATION_INTENT: Record<string, string> = {
  ...
  'assembly_association.claim.set': 'scope.association.legacy_claim.set',
  'assembly_association.relation.set': 'scope.association.set',
  'assembly_association.relation.clear': 'scope.association.clear',
  'home_locality.relation.set': 'scope.home.set',
  'home_locality.claim.set': 'scope.home.legacy_claim.set',

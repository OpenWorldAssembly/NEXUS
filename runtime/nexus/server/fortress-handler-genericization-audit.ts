...
export const FORTRESS_HANDLER_GENERICIZATION_ENTRIES = [
  ...
  {
    mutation_intent: 'relation.participation.attestation.set',
    domain: 'role',
    prepare_handler: 'prepareRoleParticipationAttestation',
    finalize_handler: 'finalizeRoleParticipationAttestation',

...
const TRUSTED_ISSUE_DESCRIPTORS = [
  ...
  },
  {
    ...
    category: 'validation',
    retryability: 'not_retryable',
    user_title: 'Certified packet keys missing',
    user_message: 'The certified packet set did not declare the exact packet revisions Archive is allowed to store.',
  },
  {
    code: 'archive.certified_packet_key_mismatch',
    legacy_aliases: ['trusted_archive_certified_packet_key_mismatch'],
    default_severity: 'error',
    category: 'validation',
    retryability: 'not_retryable',
    user_title: 'Archive packet key mismatch',
    user_message: 'The extracted archive packet revisions did not match the certified packet revisions.',
  },
  {
  ...
  },
  {
    ...
    legacy_aliases: [
      ...
      'certification.signed_packet_structural_invalid',
      'certification.duplicate_signed_packet',
    ],
    default_severity: 'error',
    category: 'signature',
    retryability: 'not_retryable',
  ...
  {
    code: 'dispatch.verified_certified_packet_mismatch',
    legacy_aliases: [],
    default_severity: 'error',
    category: 'validation',
    retryability: 'not_retryable',
    user_title: 'Verified packets do not match certification',
    user_message: 'The verified packet revisions did not match the certified packet revisions.',
  },
  {
    code: 'dispatch.mutation_intent_mismatch',
    legacy_aliases: [],
    default_severity: 'error',
    category: 'validation',
    retryability: 'not_retryable',
    user_title: 'Mutation intent mismatch',
    user_message: 'The finalize request label did not match the certified write plan.',
  },
  {
    code: 'dispatch.archive_certified_packet_mismatch',
    legacy_aliases: [],
    default_severity: 'error',
    category: 'storage',
    retryability: 'unknown',
    user_title: 'Archive receipt mismatch',
    user_message: 'Archive reported stored packet revisions that did not match the certified packet revisions.',
  },
  {

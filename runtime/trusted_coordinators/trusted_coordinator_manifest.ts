...
export const TRUSTED_COORDINATOR_SCAFFOLD_MANIFEST = [
  ...
  },
  {
    ...
    public_import_path: '@runtime/trusted_coordinators/trusted_definition_coordinator',
  ...
  },
  {
    ...
    public_import_path: '@runtime/trusted_coordinators/trusted_regulation_coordinator',
  ...
  },
  {
    ...
    public_import_path: '@runtime/trusted_coordinators/trusted_planning_coordinator',
  ...
  },
  {
    ...
    public_import_path: '@runtime/trusted_coordinators/trusted_building_coordinator',
    runtime_path: 'runtime/trusted_coordinators/trusted_building_coordinator.ts',
    structure: 'legacy_flat',
    expected_methods: [
      { method_name: 'buildFromOperationPlan', notes: 'Planned future public method once Building is foldered.' },
    ],
    notes: 'Still flat. Next target after shared scaffold hardening.',
  },
  {
